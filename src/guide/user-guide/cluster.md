...
```Shell
    ...
    curl -X 'POST' \
        ...
        -d '{
                ...
                # 集群的 kubeconfig 文件内容：使用物理集群的 kubeconfig 替换该变量，并且需要对 kubeconfig 转义换行符或者以 Base64 方式编码。
...
```Shell
    ...
    curl -X 'POST' \
        ...
        -d '{
                ...
                # 集群的 kubeconfig 文件内容：使用宿主集群的 kubeconfig 替换该变量，并且需要对 kubeconfig 转义换行符或者以 Base64 方式编码。
                "kubeconfig": $kubeconfig
            }'
```
